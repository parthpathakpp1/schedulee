...
export default function TermsOfService() {
  return (
    <div className="container mx-auto px-4 py-8">
      <Head>
        <title>Terms of Service - Schedulee</title>
        <meta name="description" content="Terms of Service for Schedulee" />
      </Head>

      <h1 className="text-3xl font-bold mb-6">
        Terms of Service for Schedulee
      </h1>
      ...
      <p className="mb-4">
        Schedulee is a call booking application that allows users to schedule,
        manage, and participate in calls. The Service may include features such
        as calendar integration, scheduling automation, and notification
        systems.
      </p>
      ...
      <p className="mb-4">
        ...
        current, and complete. You are responsible for safeguarding the password
        that you use to access the Service and for any activities or actions
        under your password.
      </p>
      ...
      <ul className="list-disc list-inside mb-4">
        ...
        <li>
          Use the Service for any purpose that is harmful, threatening, abusive,
      ...
      <p className="mb-4">
        ...
        and will remain the exclusive property of [Your Name or Company Name]
        and its licensors. The Service is protected by copyright, trademark, and
        other laws of both the [Your Country] and foreign countries.
      </p>
      ...
      <p className="mb-4">
        ...
        are not owned or controlled by Schedulee. We have no control over, and
      ...
      <p className="mb-4">
        In no event shall [Your Name or Company Name], nor its directors,
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-4">9. Disclaimer</h2>
